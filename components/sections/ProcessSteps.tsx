...
const localizedSteps: Record<string, { title: string; text: string }[]> = {
  ...
  ru: [
    { title: "Анализ требований", text: "Мы изучаем описание продукта, чертежи, фотографии, целевое количество, требования рынка и риски до поиска поставщиков." },
    { title: "Поиск и отбор поставщиков", text: "Мы определяем потенциальных поставщиков и сравниваем их специализацию, качество коммуникации, производственные возможности и экспортный опыт." },
    { title: "Сравнение цен и спецификаций", text: "Мы сравниваем предложения, спецификации, материалы, сроки, MOQ, упаковку и условия оплаты, чтобы снизить скрытые риски." },
    { title: "Образец или пробный заказ", text: "Мы координируем образцы, небольшие пробные заказы, технические замечания и улучшения перед крупными заказами." },
    { title: "Проверка качества", text: "Мы поддерживаем координацию инспекции, фото и видео проверок, контроль упаковки и коммуникацию перед отгрузкой." },
    { title: "Экспорт и доставка", text: "Мы отслеживаем экспортные документы, подготовку поставщика к отгрузке, консолидацию и логистическую коммуникацию." },
    { title: "Долгосрочное сопровождение", text: "Мы помогаем создавать повторяемые каналы закупки, базу поставщиков, планы повторных заказов и долгосрочную поддержку." }
  ],
  ar: [
    { title: "مراجعة المتطلبات", text: "نراجع تفاصيل المنتج والرسومات والصور والكمية المستهدفة ومتطلبات السوق ومخاطر التوريد قبل البحث عن الموردين." },
    { title: "البحث عن الموردين وفرزهم", text: "نحدد الموردين المحتملين ونقارن تخصصهم وجودة التواصل والقدرة الإنتاجية وخبرة التصدير." },
    { title: "مقارنة العروض الفنية", text: "نقارن الأسعار والمواصفات والمواد والمدة والحد الأدنى والعبوة وشروط الدفع لتقليل المخاطر المخفية." },
    { title: "العينات أو الطلب التجريبي", text: "نساعد في تنسيق العينات والطلبات الصغيرة والملاحظات الفنية ونقاط التحسين قبل الطلبات الأكبر." },
    { title: "فحص الجودة", text: "ندعم تنسيق الفحص والصور والفيديو ومراجعة التغليف والتواصل قبل الشحن." },
    { title: "دعم التصدير والشحن", text: "نتابع مستندات التصدير وتجهيز المورد للشحنة واحتياجات التجميع والتواصل اللوجستي." },
