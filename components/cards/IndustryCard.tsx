...
export function IndustryCard({ industry, locale = "en" }: { industry: Industry; locale?: string }) {
  return (
    <Link href={`/${locale}/industries/${industry.slug}/`} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-industrial">
