  ...
  return (
    <>
      ...
      {isSourcingCase ? (
        ...
        <CTASection
          title={isCustomCuttingToolsGuide ? "Need a Custom Cutting Tool for a Specific Machining Operation?" : isCustomScrewsGuide ? "Need a Custom Screw Made to a Drawing or Sample?" : isPrecisionMachiningGuide ? "Need a CNC Machined Part Made to Your Drawing?" : undefined}
