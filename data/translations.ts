...
export const coreCopy: Record<Locale, {
  ...
  fr: {
    ...
    contact: {
      ...
      whatsapp: "Contacter sur WhatsApp",
      successMessage: "Merci. Votre demande a été envoyée. Nous vous répondrons dès que possible.",
      errorMessage: "Désolé, votre demande n’a pas pu être envoyée. Veuillez nous contacter par email ou WhatsApp.",
...
coreCopy.es = {
  ...
  contact: {
    ...
    errorMessage: "Lo sentimos, no se pudo enviar la consulta. Por favor contáctenos por email o WhatsApp.",
...
coreCopy.ru = {
  ...
  contact: {
    ...
    whatsapp: "Связаться в WhatsApp",
    successMessage: "Спасибо. Ваш запрос был отправлен. Мы ответим вам как можно скорее.",
    errorMessage: "К сожалению, запрос не удалось отправить. Пожалуйста, свяжитесь с нами по email или WhatsApp.",
