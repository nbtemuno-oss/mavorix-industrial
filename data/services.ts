...
export const services: Service[] = [
  {
    ...
    description: "Structured China industrial sourcing for machinery, OEM parts, factory spare parts, MRO supplies, metal parts, supplier checks, and mixed shipment coordination.",
  ...
  },
  {
    ...
    description: "MRO sourcing from China for factory spare parts, industrial MRO suppliers, maintenance consumables, mixed repair items, supplier checks, and consolidated procurement.",
  ...
  },
  {
    ...
    description: "Supplier verification in China to help overseas buyers check supplier identity, trading company risk, capability, quotation clarity, documents, payment risk, and order execution before committing.",
