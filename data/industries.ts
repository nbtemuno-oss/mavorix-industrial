...
export const industries: Industry[] = [
  ...
  { slug: "mro-supplies", title: "MRO Supplies", description: "China sourcing for maintenance, repair, operation supplies, factory consumables, replacement parts, tools, and electrical-mechanical supplies.", image: "/images/service-mro-sourcing.webp", products: ["Factory consumables", "Replacement parts", "Tools", "Maintenance supplies", "Mechanical and electrical supplies"] },
  { slug: "electrical-mechanical-parts", title: "Electrical and Mechanical Parts", description: "Sourcing support for motors, sensors, switches, bearings, pumps, valves, reducers, pneumatic parts, and hydraulic components.", image: "/images/industry-industrial-machinery.webp", products: ["Motors", "Sensors", "Bearings", "Pumps and valves", "Pneumatic and hydraulic parts"] },
  { slug: "factory-spare-parts", title: "Factory Spare Parts", description: "Sourcing support for production line replacement parts, mechanical spares, electrical spares, maintenance parts, and emergency sourcing needs.", image: "/images/service-mro-sourcing.webp", products: ["Production line spares", "Mechanical parts", "Electrical parts", "Maintenance spares", "Emergency sourcing support"] }
];
