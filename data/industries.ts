...
export const industries: Industry[] = [
  ...
  { slug: "metal-parts", title: "Metal Parts", description: "China metal parts sourcing for fasteners, stainless steel screws, CNC machined components, stamped parts, gears, spacers, and custom drawing-based hardware.", image: "/images/industry-metal-parts.webp", products: ["Fasteners and screws", "CNC machined parts", "Stamped parts", "Fabrication parts", "Custom metal components"] },
  { slug: "mro-supplies", title: "MRO Supplies", description: "China sourcing support for industrial MRO suppliers, factory spare parts, maintenance consumables, tools, and mixed repair items that can be checked and consolidated before export.", image: "/images/industry-mro-supplies.webp", products: ["Factory consumables", "Replacement parts", "Tools", "Maintenance supplies", "Mechanical and electrical supplies"] },
